...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent EagleCode from reading sensitive files",
  "Use {highlight}eaglecode run{/highlight} for non-interactive scripting",
  "Use {highlight}eaglecode --continue{/highlight} to resume the last session",
  "Use {highlight}eaglecode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}eaglecode serve{/highlight} for headless API access to EagleCode",
  "Use {highlight}eaglecode run --attach{/highlight} to connect to a running server",
  "Run {highlight}eaglecode upgrade{/highlight} to update to the latest version",
  "Run {highlight}eaglecode auth list{/highlight} to see all configured providers",
  "Run {highlight}eaglecode agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}eaglecode debug config{/highlight} to troubleshoot configuration",
